...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ordenard_pushButton = QPushButton(self.groupBox)
        self.ordenard_pushButton.setObjectName(u"ordenard_pushButton")

        self.gridLayout.addWidget(self.ordenard_pushButton, 16, 0, 1, 3)

        self.ordenari_pushButton = QPushButton(self.groupBox)
        self.ordenari_pushButton.setObjectName(u"ordenari_pushButton")

        self.gridLayout.addWidget(self.ordenari_pushButton, 14, 0, 1, 3)
        ...
        self.ordenarv_pushButton = QPushButton(self.groupBox)
        self.ordenarv_pushButton.setObjectName(u"ordenarv_pushButton")

        self.gridLayout.addWidget(self.ordenarv_pushButton, 15, 0, 1, 3)

        self.mostrarg_pushButton = QPushButton(self.groupBox)
        self.mostrarg_pushButton.setObjectName(u"mostrarg_pushButton")

        self.gridLayout.addWidget(self.mostrarg_pushButton, 17, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.actionAmplitud.setText(QCoreApplication.translate("MainWindow", u"Amplitud", None))
        ...
        self.ordenard_pushButton.setText(QCoreApplication.translate("MainWindow", u"OrdenarDis", None))
        self.ordenari_pushButton.setText(QCoreApplication.translate("MainWindow", u"OrdenarID", None))
        self.ordenarv_pushButton.setText(QCoreApplication.translate("MainWindow", u"OrdenarVel", None))
        self.mostrarg_pushButton.setText(QCoreApplication.translate("MainWindow", u"MostrarGrafo", None))
